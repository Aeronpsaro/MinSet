...
$(BUILD)/ReadWords.o: $(SRC)/ReadWords.c $(BUILD)/StringSet.o
	$(CC) $(DEBUGFLAGS) -c $(SRC)/ReadWords.c deps/templated-hashmap/hashmap.o $(BUILD)/StringSet.o -o $(BUILD)/ReadWords.o
